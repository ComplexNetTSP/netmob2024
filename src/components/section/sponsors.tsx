    ...
    <div className="bg-slate-50">
      <div className='pb-20 container mx-auto max-w-screen-lg'>
        ...
        <div id='sponsors-logo' className='pt-10 flex justify-center items-center gap-8'>
          ...
          <Link href="https://www.worldbank.org/en/home"><Image src='/img/sponsors/dime.png' alt='World Bank logo' width={250} height={60} /></Link>
          ...
          <Link href="https://www.worldbank.org/en/home"><Image src='/img/sponsors/gdf.webp' alt='World Bank logo' width={250} height={60} /></Link>
