  ...
  return (
    <div className={cn('bg-slate-50', className)} {...rest}>
      <div className='pt-20 container mx-auto max-w-xs sm:max-w-xl md:max-w-screen-sm xl:max-w-screen-lg'>
        ...
        <div className='pt-5'>
        Colocated with NetMob 2024, we are launching the NetMob 2024 Data Challenge. 
        The objective of the NetMob 2024 Data Challenge is to promote competition focused on extracting and applying insights from mobility data. 
        The aim is to enhance understanding of deriving population density from mobility data samples, assessing the impact of climate conditions or 
        climate-related hazards on human mobility patterns, and identifying various applications of mobility-based metrics to inform public policies.
        </div>
