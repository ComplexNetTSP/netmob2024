        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 lg:gap-10'>
          <div id='where-main-section' className='mt-10 flex flex-col'>
            ...
            <div className='flex flex-col mt-5 space-y-3'>
              ...
              <div><span className='font-medium'>Nearby metro stations</span>: <Link className='underline decoration-red-400' href="https://washington.org/navigating-dc-metro">Farragut West on the blue, orange and silver line</Link></div>
            </div>
          </div>
