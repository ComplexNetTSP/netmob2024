  ...
  return (
    <>
      <div className="relative h-screen flex items-center z-0 overflow-hidden justify-center">
        ...
        {width &&
          <video loop muted playsInline autoPlay disablePictureInPicture poster={`${videoSource(width)}.png`} className="absolute blur-[2px] lg:blur-none z-0 top-0 w-auto min-w-full min-h-full max-w-none object-cover">
        ...
        <div className='container mx-auto max-w-xs h-full content-end lg:content-center sm:max-w-xl md:max-w-screen-sm xl:max-w-screen-lg grid grid-cols-1 lg:grid-cols-2 justify-center'>
          <div id="hero-title" className='z-20 px-10 py-10 lg:col-start-2'>
            <div id="hero-text" className='flex flex-col items-center lg:items-start'>
              <div className='text-slate-50 text-3xl sm:text-8xl lg:text-6xl xl:text-8xl font-light italic font-atrament flex flex-row lg:flex-col'><div>NetMob</div><div className="ml-3 lg:ml-0">2024</div></div>
              <div className='text-xl sm:text-5xl lg:text-2xl xl:text-3xl text-slate-50 font-light italic font-atrament pt-2'>Washington DC, 7-9 Oct 2024</div>
              <div className='pt-6 text-sm lg:text-xl xl:text-xl text-slate-50'>NetMob is the primary conference on the analysis of mobile phone datasets in social, urban, societal and industrial problems.</div>
              <HeroButton />
            </div>
          </div>
        </div>
