  ...
  return (
    <div className={cn('bg-slate-50', className)} {...rest}>
      <div className='pt-20 pb-10 container mx-auto max-w-xs sm:max-w-xl md:max-w-screen-sm xl:max-w-screen-lg'>
        ...
        { /* table  */}
        <div id='register-table' className='mt-10 px-4 mx-auto max-w-xs sm:max-w-xl flex justify-center rounded-xl shadow-xl border bg-slate-100'>
          <table className="w-full mt-4 border-separate border-spacing-y-3">
            ...
            <caption className="mt-10 mb-5 caption-bottom">
      ...
      <div className='pt-20 pb-10 container mx-auto max-w-xs sm:max-w-xl md:max-w-screen-sm xl:max-w-screen-lg'>
        { /* refound */}
        <div id='refound' className='pt-10 flex text-4xl font-atrament'>Cancellation Policy</div>
