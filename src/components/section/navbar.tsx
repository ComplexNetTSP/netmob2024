...
export default function Navbar(props: HTMLProps<HTMLDivElement>) {
  ...
  return (
    <nav className={style} {...rest}>
      {/* Mavbar */}
      <div className="container mx-auto max-w-xs sm:max-w-xl lg:max-w-screen-lg flex justify-between items-center gap-5 text-lg font-normal mt-3 py-2 rounded-xl shadow-lg text-slate-50">
      ...
      <div id="nav-mobile-menu" className='hidden mx-4 mt-8 mb-5 flex-col text-white text-xl space-y-3'>
        ...
        <button className='flex justify-normal'>Registration</button>
